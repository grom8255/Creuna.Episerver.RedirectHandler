...
namespace Creuna.Episerver.RedirectHandler.Core.Obsolete
{
    /// <summary>
    ...
    public class CustomRedirect : IDynamicData
    {
        ...
        private bool _wildCardSkipAppend;
        ...
        {
            get { return _wildCardSkipAppend; }
            set { _wildCardSkipAppend = value; }
        }

        public string OldUrl
        {
            get { return _oldUrl.ToLower(); }
            set { _oldUrl = value; }
        }

        public string NewUrl
        {
            get { return _newUrl.ToLower(); }
            set { _newUrl = value; }
        }
