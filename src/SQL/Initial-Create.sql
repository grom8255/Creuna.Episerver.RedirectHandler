...
INSERT INTO  [dbo].[CustomRedirects]
	  ([NewUrl]
      ,[OldUrl]
      ,[AppendMatchToNewUrl]
      ,[ExactMatch]
      ...
      ,[State]
      ,[NotfoundErrorCount])
select string03, string01, boolean01, boolean02, boolean03,0,0 from tblbigtable where storename = 'Creuna.Episerver.RedirectHandler.CustomRedirect'
AND NOT EXISTS (select 1 from [dbo].customredirects where oldurl = string01)
GO
